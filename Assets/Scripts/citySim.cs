...
public class citySim : MonoBehaviour {
	...
	void Start () {
		...
		causesOfDeath = new causeOfDeath[]{
			new causeOfDeath ("an intestinal infection", deathsData, 0),
			new causeOfDeath ("a bacterial disease", deathsData, 2),
			new causeOfDeath ("Septicaemia", deathsData, 4),
			new causeOfDeath ("cancer", deathsData, 6),
			new causeOfDeath ("a disease of the blood", deathsData, 8),
			new causeOfDeath ("diabetes", deathsData, 10),
			new causeOfDeath ("dementia", deathsData, 12),
			new causeOfDeath ("Parkinson's disease", deathsData, 14),
			new causeOfDeath ("Alzheimer’s disease", deathsData, 16),
			new causeOfDeath ("heart disease", deathsData, 18),
			new causeOfDeath ("pneumonia", deathsData, 20),
			...
			new causeOfDeath ("general senility", deathsData, 34),
			new causeOfDeath ("sudden infant death syndrome", deathsData, 36),
			new causeOfDeath ("a fall", deathsData, 38),
